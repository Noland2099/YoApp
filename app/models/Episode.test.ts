...
const data = {
    ...
    thumbnail: "https://image.simplecastcdn.com/images/fd1212b1-7d08-4c5a-8506-00188a4c6528/acb9f5dc-7451-42af-8c97-2f0f29d122ae/3000x3000/rnr-episode-rnr244.jpg?aid=rss_feed",
    description: "",
    content: "",
    enclosure: {
...
test("publish date format", () => {
    ...
    expect(episode.datePublished.accessibilityLabel).toBe("demoPodcastListScreen:accessibility.publishLabel");
});

test("duration format", () => {
    expect(episode.duration.textLabel).toBe("42:58");
    expect(episode.duration.accessibilityLabel).toBe("demoPodcastListScreen:accessibility.durationLabel");
});
